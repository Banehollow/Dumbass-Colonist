...
bool PlayGame(int LevelDifficulty)
{
	...
	*/
	if (LevelDifficulty <= 1)
	{
		...
		Sleep(2000);
		std::cout << "...And one number at a time, bonehead" << std::endl;
	}
	else
	{
...
int main()
{
	PlaySound(TEXT("E:\\C++ Projects\\Dumbass Colonist\\Aliens Theme.wav"), NULL, SND_FILENAME | SND_LOOP | SND_ASYNC);
	//PlaySound(TEXT("E:\\C++ Projects\\BloodEclipse\\01. Madonna - Subsitute for Love.wav"), NULL, SND_FILENAME | SND_ASYNC);
	system("PAUSE");
	srand(time(NULL));
	...
	PlaySound(TEXT("E:\\C++ Projects\\Dumbass Colonist\\Victory Music.wav"), NULL, SND_FILENAME | SND_ASYNC);
	/*	  <<<<<<<<<<<<<< Return Statement >>>>>>>>>>>>>>>>>>
